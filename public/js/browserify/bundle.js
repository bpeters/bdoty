    ...
    return (
      React.DOM.html(null, 
        React.DOM.head({lang: "en"}, 
          ...
          React.DOM.title(null, this.state.title), 
          React.DOM.link({href: "//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css", rel: "stylesheet"}), 
          React.DOM.link({href: "//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css", rel: "stylesheet"}), 
          React.DOM.link({href: "/css/style.css", rel: "stylesheet"})
        ), 
        React.DOM.body(null, 
          React.DOM.div({id: "body"}), 
          React.DOM.span({id: "props", dangerouslySetInnerHTML: {__html: json}}), 
...
},{"./App.jsx":147,"./components/Home.jsx":149,"jquery":2,"react":146}],149:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
    ...
    return (
      React.DOM.div({className: "container-fluid"}, 
        React.DOM.div({className: "row"}, 
          React.DOM.div({style: style, className: "image"}), 
          React.DOM.div({className: "col-md-4 col-md-offset-4"}, 
            React.DOM.div({className: "row"}, 
              React.DOM.div({className: "title col-md-12"}, 
                React.DOM.h4(null, "PHOTOGRAPHY BY"), 
                React.DOM.h1(null, "BILL DOTY")
              )
            ), 
            React.DOM.div({className: "boxes row"}, 
              previews
            ), 
            React.DOM.div({className: "row"}, 
              React.DOM.div({className: "copyright col-md-12"}, 
                React.DOM.p(null, "All Images © 2014 Bill Doty")
              )
            )
          )
        )
